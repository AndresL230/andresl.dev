...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: 'Shared memory for a team building with coding agents: docs, tickets, roadmap, and repo health in one Cloudflare Worker.',
    ...
    gallery: [
      ...
      { src: '/images/canopy_search.png', caption: 'Canopy · search, every hit flagged live or staged' },
    ],
    ...
    solution:
      'Canopy is that store. Agents read and propose over MCP; every write lands staged until a human approves it. Around it: a ticket queue, sprints, a roadmap, and a repo dashboard.',
    deepDive: [
      'One Worker serves the API, an MCP endpoint, a GitHub webhook, and the SPA. D1 is the only datastore.',
      'Every agent write passes one gate: a replay ledger, content-hash dedupe, and a line diff that types each change. Approving is never an MCP tool.',
      'Agents can only touch tickets their person is assigned to. Nothing is closed automatically; a person decides.',
      'The repo dashboard reads only captured data, never GitHub at render, and shows "not connected" instead of a guessed zero. 1,750 tests run against real D1.',
    ],
  },
  {
    slug: 'calyx',
