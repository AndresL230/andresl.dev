          ...
          <React.Fragment key={i}>
            ...
            >
              ...
              <motion.div
                ...
                transition={{
                  opacity: { duration: 0.45, ease: [0.23, 1, 0.32, 1] as const },
                  scale: { duration: 0.55, ease: [0.23, 1, 0.32, 1] as const },
                }}
              >
                <img
                  src={item.image}
              ...
              <div className="absolute inset-0 flex items-end px-5 pb-4 z-10 pointer-events-none">
